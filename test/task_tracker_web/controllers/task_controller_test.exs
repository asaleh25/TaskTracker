defmodule TaskTrackerWeb.TaskControllerTest do
  ...
  @create_attrs %{complete: true, desc: "some desc", timespent: 42, title: "some title"}
  @update_attrs %{complete: false, desc: "some updated desc", timespent: 43, title: "some updated title"}
  @invalid_attrs %{complete: nil, desc: nil, timespent: nil, title: nil}
